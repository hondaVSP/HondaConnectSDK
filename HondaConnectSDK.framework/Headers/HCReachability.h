...
typedef NS_ENUM(NSUInteger, HCReachabilityStatus) {
    HCReachabilityStatusNone  = 0, ///< Not Reachable
    HCReachabilityStatusWWAN  = 1, ///< Reachable via WWAN (2G/3G/4G)
    HCReachabilityStatusWiFi  = 2, ///< Reachable via WiFi
};

typedef NS_ENUM(NSUInteger, HCReachabilityWWANStatus) {
    HCReachabilityWWANStatusNone  = 0, ///< Not Reachable vis WWAN
    HCReachabilityWWANStatus2G = 2, ///< Reachable via 2G (GPRS/EDGE)       10~100Kbps
    HCReachabilityWWANStatus3G = 3, ///< Reachable via 3G (WCDMA/HSDPA/...) 1~10Mbps
    HCReachabilityWWANStatus4G = 4, ///< Reachable via 4G (eHRPD/LTE)       100Mbps
};


/**
 `HCReachability` can used to monitor the network status of an iOS device.
 */
@interface HCReachability : NSObject

@property (nonatomic, readonly) SCNetworkReachabilityFlags flags;                           ///< Current flags.
@property (nonatomic, readonly) HCReachabilityStatus status;                                ///< Current status.
@property (nonatomic, readonly) HCReachabilityWWANStatus wwanStatus NS_AVAILABLE_IOS(7_0);  ///< Current WWAN status.
...
@property (nullable, nonatomic, copy) void (^notifyBlock)(HCReachability *reachability);

...
/**
 HCTimer is a thread-safe timer based on GCD. It has similar API with `NSTimer`.
 HCTimer object differ from NSTimer in a few ways:
 ...
 */
@interface HCTimer : NSObject

+ (HCTimer *)timerWithTimeInterval:(NSTimeInterval)interval
                            target:(id)target
